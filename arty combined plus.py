...
def combinedRun():
    print("")
    print("")
    typeIn = input("Type of art generated (pixeldots,fadetowhite,fulllines,chunkylines,knitted,knittedvertical,"
                   "knittedlandscape,desktop): ")
    if typeIn == "pixeldots":
        ...
        pixelMaker()
        out = im.rotate(90)
        out.save("knittedvertical" + ".png", "PNG")
        combinedRun()
